...
public class OpusHeader2 extends OpusHandleBasedSupport implements OggPacket.ToPacketConvertible {

    OpusHeader2(long handle, boolean autoDestroy) {
    ...
    public OpusHeader2(byte[] packet) {
        this(OpusHeaderJNI.create(), true);
