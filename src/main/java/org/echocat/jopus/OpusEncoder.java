...
public class OpusEncoder {
    ...
    protected static OpusHeader createHeaderFor(OpusEncoder encoder) {
    ...
    private static OggPacket encodeAndWrite(OpusEncoder encoder, int frameSize, short[] pcm, OggPacket lastPacket) throws IOException {
